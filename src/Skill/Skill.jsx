    ...
    return(
        <>
          ...
          <Canvas orthographic camera={{ zoom: 50, position: [0, 0, 10] }} >
            ...
            <Model position={[2, 1, 2]} modelPath="/democv/public/models/mongodb.glb" />
          ...
          <Canvas orthographic camera={{ zoom: 50, position: [0, 0, 10] }} >
            ...
            <Model position={[2, 1, 2]} modelPath="/democv/public/models/expresss.glb" />
          ...
          <Canvas orthographic camera={{ zoom: 50, position: [0, 0, 10] }} >
            ...
            <Model position={[2, 1, 2]} modelPath="/democv/public/models/react_logo.glb" />
          ...
          <Canvas orthographic camera={{ zoom: 50, position: [0, 0, 10] }} >
            ...
            <Model position={[2, 1, 2]} modelPath="/democv/public/models/nodejs.glb" />
          ...
          <Canvas orthographic camera={{ zoom: 50, position: [0, 0, 10] }} >
            ...
            <Model position={[2, 1, 2]} modelPath="/democv/public/models/htmllogo6.glb" />
          ...
          <Canvas orthographic camera={{ zoom: 70, position: [0, 0, 10] }} >
            ...
            <Model position={[2, 1, 2]} modelPath="/democv/public/models/CSS.glb" />
          ...
          <Canvas orthographic camera={{ zoom: 70, position: [0, 0, 10] }} >
            ...
            <Model position={[2, 1, 2]} modelPath="/democv/public/models/javascript.glb" />
